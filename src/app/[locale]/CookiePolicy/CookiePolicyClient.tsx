...
export default function CookiePolicyClient({ locale }: { locale: string }) {
      ...
      <div className="container mx-auto px-6 py-16 max-w-5xl">
        ...
        <div className="prose prose-3xl max-w-none mx-auto text-gray-700">
          ...
          <ul className="list-disc pl-12 mb-12 space-y-6">
            ...
            <li className="text-2xl"><span className="font-semibold text-gray-800">Our Privacy Settings:</span> Visit our privacy settings page to adjust your preferences <a href={`/${locale}/PrivacyPolicy`} className="text-[#2ae8d3] hover:text-yellow-400 transition-colors duration-200">Privacy Policy</a>.</li>
